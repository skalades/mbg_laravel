...
export default function EditMenu({ menu, foodItems, schools }: Props) {
    ...
    return (
        <AuthenticatedLayout header="Edit Menu Presisi">
            <Head title={`Edit ${menu.menu_name}`} />
                ...
                <form onSubmit={submit} className="max-w-[1600px] mx-auto space-y-8">
                    ...
                    <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 bg-white p-6 rounded-[2.5rem] shadow-sm border border-emerald-900/5">
                        <div className="flex items-center gap-4">
                            <Link href={route('menus.index')} className="w-12 h-12 bg-slate-100 text-slate-400 rounded-2xl flex items-center justify-center hover:bg-emerald-900 hover:text-white transition-all">
                        ...
                        <div className="flex flex-wrap items-center gap-4">
                            ...
                            <TextInput
                                className="bg-emerald-50/50 border-emerald-900/5 rounded-2xl px-6 py-3 text-sm font-bold min-w-[250px]"
                        ...
                        <div className="lg:col-span-8 space-y-8">
                            ...
                            <div className="bg-white p-10 rounded-[3rem] border border-emerald-900/5 shadow-sm relative group">
                                ...
                                <div className="mt-10 relative">
                                    ...
                                    <input 
                                        type="text"
                                        placeholder="Cari bahan makanan untuk ditambahkan..."
                        ...
                        <div className="lg:col-span-4 sticky top-8">
                            <section className="bg-slate-900 p-10 rounded-[3.5rem] text-white shadow-2xl relative overflow-hidden">
                                ...
                                <div className="relative z-10 space-y-12">
                                    ...
                                    >
                                        <span className="text-xs font-black uppercase tracking-[0.3em]">Perbarui Resep</span>
